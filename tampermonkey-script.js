...
class App {
    ...
    async start({
        ...
        if (textarea) {
            ...
            const enterEvent = new KeyboardEvent("keydown", {
                ...
                charCode: 13, // Deprecated, but included for compatibility
                which: 13, // Deprecated, but included for compatibility
                bubbles: true
            });
    ...
    async getReponds() {
        ...
        if(lastText.includes('Something went wrong') || lastText == ''){
